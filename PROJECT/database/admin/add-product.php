    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div>
                    <div  class="add_cate btn btn-success me-2 " data-bs-toggle="modal" data-bs-target="#addbrand">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-titlec bold" id="staticBackdropLabel" style="font-size: 20px;">Add a new category</h5>
                                ...
                                <div class="modal-body">
                                    <form action="" method="post">
                                        ...
                                        <input type="submit" name="addbrand" value="Thêm">
                                    </form>
                                </div>
