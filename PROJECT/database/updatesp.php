...
//  die();
 ...
 if(!empty($images[0])){
    ...
    foreach($images as $key => $value){
        move_uploaded_file($ima['tmp_name'][$key], 'uploads/' . $value);
     }
     foreach($images as $key => $value){
            ...
            <div class="col-12">
                <form method="post" action=""  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <option value="">___BRAND___</option>
                    ...
                    <img src="../database/uploads/<?php echo $pro['image'] ?>" alt="" width="100">
                    </div>
                    <div class="form-group">
                    ...
                    foreach($img_pro as $key => $value){?>
                            <div class="col-md-4">
                                 <a href="#" class="thumbnail">
                                    <img src="uploads/<?php echo $value['image'] ?>" alt="" width="200px">
                                 </a>
                            </div>
                   <?php } ?>
